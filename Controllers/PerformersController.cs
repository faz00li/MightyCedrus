...
namespace MightyCedrus.Controllers
{
    public class PerformersController : Controller
    {
        ...
        public PerformersController(MightyCedrusContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,FullName,Payout")] Performer performer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,FullName,Payout")] Performer performer)
        {
            if (id != performer.Id)
            {
                return NotFound();
